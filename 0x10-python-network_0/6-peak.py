...
def find_peak(list_of_integers):
    ...
    Naive solution is to go through the list element by element.
    which make the time complexity o(n)
    A better solution would be a binary search with a time complexity of
    0(log(n)).
